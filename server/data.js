...
// Single demo account — auth is a mock bearer token, kept intentionally
// simple since the design has one always-logged-in buyer persona.
export const DEMO_CNPJ = '12.345.678/0001-90';
export const DEMO_TOKEN = 'demo-token-padaria-aurora';
...
// Mutable server-side state (per single demo account — this is a mock, not multi-tenant)
export const state = {
  cart: new Map([
    ['feijao', 180],
    ['fuba', 150],
